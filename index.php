...
<div class="card-title">multi-cloud-app</div>
</div>
          ...
          <td>
                <?php
                        ...
                        if (strpos($org, 'Google') !== false) {
                            echo "<img height='50px' src='images/org-google.png' />"; 
                        }
                        else if (strpos($org, 'Amazon') !== false) {
                            echo "<img height='50px' src='images/org-aws.jpg' />"; 
                        }
                        else if (strpos($org, 'Microsoft') !== false) {
                            echo "<img height='50px' src='images/org-azure.png' />"; 
                        }
                        else {
                            echo $org;
                        }
